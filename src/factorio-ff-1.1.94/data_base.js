...
const _hack_add_reactor = function (data) {
    ...
    data.add_factory(new Factory('basic-reactor', 'basic-reactor', [data.factory_groups['basic-reactor']], 1));
    data.add_factory(new Factory('breeder-reactor', 'breeder-reactor', [data.factory_groups['breeder-reactor']], 1));
    data.add_factory(new Factory('mox-reactor', 'mox-reactor', [data.factory_groups['mox-reactor']], 1));
}
