...
data.add_factories([
    ...
    new Factory('assembler_II', 'assembler II', factory_groups.assembler, 1 / 1.25),
    new Factory('assembler_III', 'assembler III', factory_groups.assembler, 1 / 1.5),
...
data.add_processes([
    ...
    new Process('glass', [new Stack(items.stone_ore, 2)], [new Stack(items.glass, 1)], 2, factory_groups.smelter),
    new Process('stone', [new Stack(items.stone_ore, 1)], [new Stack(items.stone, 1)], 1, factory_groups.smelter),
    new Process(
        'titanium_plate',
    ...
    new Process('steel', [new Stack(items.iron_plate, 3)], [new Stack(items.steel, 1)], 3, factory_groups.smelter),
    new Process(
        'energetic_graphite',
    ...
    new Process('magnet', [new Stack(items.iron_ore, 1)], [new Stack(items.magnet, 1)], 1.5, factory_groups.smelter),
    new Process(
        'copper_plate',
    ...
    new Process('gear', [new Stack(items.iron_plate, 1)], [new Stack(items.gear, 1)], 1, factory_groups.assembler),
]);
